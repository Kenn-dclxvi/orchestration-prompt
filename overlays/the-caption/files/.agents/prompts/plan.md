...
- 実装工程: `.agents/prompts/implement.md`、`target / scope / done / tests / stop`、実装指示
- 契約準拠の判定工程: `.agents/prompts/audit.md`、判定指示 / 判定対象 / 判定観点、入力成果物: 承認済み実装指示書 / 差分 / テスト結果 / 関連仕様
- 契約準拠の判定工程で使う `停止指摘 / 任意指摘 / 範囲外指摘` の判定基準
- 品質確認工程: `.agents/prompts/review.md`、確認指示 / 確認対象 / 確認観点、入力成果物: 承認済み実装指示書 / 差分 / テスト結果 / 契約準拠の判定工程が済み停止指摘0件である前提 / 関連仕様
